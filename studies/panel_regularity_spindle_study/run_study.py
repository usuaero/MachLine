...
if __name__=="__main__":
    ...
    for N in Ns:
        ...
        plt.savefig('studies/panel_regularity_spindle_study/plots/M_{0}_{1}.pdf'.format(M, N))
        plt.savefig('studies/panel_regularity_spindle_study/plots/M_{0}_{1}.svg'.format(M, N))
        plt.close()