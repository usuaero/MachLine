...
# this script tests sensitivities of CP_isentropic wrt vars (dirichlet subsonic wake present)
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_tests/wake_test20_d_CP_ise_vars/wake_test20_d_CP_ise_vars.f90"])
