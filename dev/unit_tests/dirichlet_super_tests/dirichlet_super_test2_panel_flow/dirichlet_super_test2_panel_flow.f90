program dirichlet_super_test2
    ...
    write(*,*) ""
    write(*,*) "-----------------------------------------------------------------------"
    write(*,*) "        Dirichlet supersonic FLOW-DEPENDENT PANEL SENSITIVITIES TEST "
    write(*,*) "-----------------------------------------------------------------------"
    write(*,*) ""
    write(*,*) ""
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!    FOR EACH PANEL       !!!!!!!!!!!!!!!!!!!!!
    ...
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) "       Dirichlet Supersonic FLOW DEPENDENT PANEL GEOMETRY TEST RESULTS "
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) ""
...
end program dirichlet_super_test2