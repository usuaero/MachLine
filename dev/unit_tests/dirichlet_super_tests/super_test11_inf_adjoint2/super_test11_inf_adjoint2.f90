program super11
    ...
    write(*,*) ""
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) "                     Supersonic inf_adjoint2 TEST                    "
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) ""
    write(*,*) ""
    ...
    do y =1,N_panels
        ...
        do z = 1,N_verts
            ...
            write(*,'(A,I5,A,I5)') "Supersonic inf adjoint2 test: Panel ",y," cp ",z
            ...
            do i=1,3
                do j=1,N_verts
                    ...
                    call test_mesh%panels(index)%calc_velocity_influences(test_mesh%cp(cp_ind)%loc,&
                     freestream_flow, mirror_panel,v_s, v_d)
                    doublet_inf = matmul(test_mesh%cp(cp_ind)%n_g, matmul(freestream_flow%B_mat_g, v_d))
                    !!!!!!!!!!!! END UPDATE !!!!!!!!!!!!!!!
    ...
    !!!!!!!!!!!!!!  RESULTS!!!!!!!!!!!!!
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) "                     Supersonic inf_adjoint2 TEST RESULTS "
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) ""
