...
# this script tests various control point sensitivities in the adjoint gradient calculation, compares them to FD
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/dirichlet_super_tests/dirichlet_super_test5_control_point/dirichlet_super_test5_control_point.f90"])
