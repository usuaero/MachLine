...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! CALC BASIC GEOM (CONTROL POINTS) SENSITIVITIES TEST !!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    write(*,*) ""
    write(*,*) "-----------------------------------------------------------------------------------"
    write(*,*) "   DIRICHLET SUPERSONIC CALC BASIC GEOM (CONTROL POINTS) SENSITIVITIES TEST "
    write(*,*) "-----------------------------------------------------------------------------------"
    write(*,*) ""
    write(*,*) ""
    write(*,*) ""
    ...
    write(*,*) "------------------------------------------------------------------------------------"
    write(*,*) "   DIRICHLET SUPERSONIC CALC_BASIC_GEOM (CONTROL POINTS) SENSITIVITIES TEST RESULTS "
    write(*,*) "------------------------------------------------------------------------------------"
    write(*,*) ""
...
end program dirichlet_super_test3