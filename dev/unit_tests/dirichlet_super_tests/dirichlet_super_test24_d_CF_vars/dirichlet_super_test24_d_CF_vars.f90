program dirichlet_super_test24
    ...
    write(*,*) ""
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) "             Dirichlet Supersonic d_CF_wrt_vars TEST                    "
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) ""
    write(*,*) ""
    ...
    if (maxval(abs(residuals3(:,:)))>error_allowed) then
        ...
        do i = 1, N_verts*3
            if (any(abs(residuals3(:,i))>error_allowed)) then
                ...
                adjoint_solver%d_C_F_wrt_vars%get_values(i)
...
end program dirichlet_super_test24