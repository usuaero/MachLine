...
# this script tests senstivities of cell CF wrt mu (dirichlet_subsonic wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_tests/wake_test23_d_cells_CF_mu/wake_test23_d_cells_CF_mu.f90"])
