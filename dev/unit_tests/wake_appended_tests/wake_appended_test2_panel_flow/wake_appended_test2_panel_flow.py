...
# this script tests flow dependent panel geometry sensitivity (dirichlet supersonic wake appended)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_appended_tests/wake_appended_test2_panel_flow/wake_appended_test2_panel_flow.f90"])
