...
# this script tests sensitivites of cell CF wrt vars (dirichlet subsonic wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_tests/wake_test22_d_cells_CF_vars/wake_test22_d_cells_CF_vars.f90"])
