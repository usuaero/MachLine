...
# this script tests total derivative of CF (dirichlet subsonic wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_appended_tests/wake_appended_test26_CF_sensitivities/wake_appended_test26_CF_sensitivities.f90"])
