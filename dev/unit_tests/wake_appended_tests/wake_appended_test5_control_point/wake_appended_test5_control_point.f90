program wake_appended_test5
    ...
    write(*,*) ""
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) "             CONTROL POINT SENSITIVITIES TEST (WAKE APPENDED)                   "
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) ""
    write(*,*) ""
...
!!!!!!!!!!!!!!   SENSITIVITIES RESULTS!!!!!!!!!!!!!
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) "          CONTROL POINT SENSITIVITIES TEST RESULTS (WAKE APPENDED)"
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) ""
...
end program wake_appended_test5