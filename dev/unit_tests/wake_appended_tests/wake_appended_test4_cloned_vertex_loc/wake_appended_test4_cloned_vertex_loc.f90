program wake_appended_test4
    ...
    write(*,*) ""
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) "         CLONED VERTEX LOCATION SENSITIVITIES TEST (WAKE APPENDED)                   "
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) ""
    write(*,*) ""
    ...
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) "         CLONED VERTEX LOCATION SENSITIVITIES TEST RESULTS (WAKE APPENDED)"
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) ""
...
end program wake_appended_test4