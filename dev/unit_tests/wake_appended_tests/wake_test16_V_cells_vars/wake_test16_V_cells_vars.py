...
# this script tests sensitivities of V_cells (dirichlet subsonic wake present) wrt vars
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_tests/wake_test16_V_cells_vars/wake_test16_V_cells_vars.f90"])
