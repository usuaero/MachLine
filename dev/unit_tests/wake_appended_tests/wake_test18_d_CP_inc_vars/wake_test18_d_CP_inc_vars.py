...
# this script tests sensitivities of CP inc of each panel wrt vars (subsonic dirichlet wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_tests/wake_test18_d_CP_inc_vars/wake_test18_d_CP_inc_vars.f90"])
