program wake_appended_test27
    ...
    test_input = "dev\input_files\adjoint_inputs\wake_appended_test_ise.json"
    ...
    adjoint_input = "dev\input_files\adjoint_inputs\wake_appended_adjoint_test_ise.json"
    ...
    write(*,*) ""
    write(*,*) "--------------------------------------------------------------------------------------"
    write(*,*) "             dirichlet final d_CF_sensitivities_test ISENTROPIC (WAKE APPENDED)"
    write(*,*) "--------------------------------------------------------------------------------------"
    write(*,*) ""
    ...
    !!!!!!!!!!!!!!  RESULTS!!!!!!!!!!!!!
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) "           dirichlet d_CF (ISENTROPIC) Final TEST RESULTS (WAKE APPENDED) "
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) ""
    write(*,'((A), f2.1)') "FREESTREAM MACH NUMBER = ", adjoint_freestream_flow%M_inf
    write(*,*) ""
...
end program wake_appended_test27
