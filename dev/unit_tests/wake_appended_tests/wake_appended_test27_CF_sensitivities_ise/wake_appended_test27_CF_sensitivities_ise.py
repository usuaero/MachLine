...
# this script tests total derivative of CF (isentropic pressure rule, dirichlet subsonic wake appended)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_appended_tests/wake_appended_test27_CF_sensitivities_ise/wake_appended_test27_CF_sensitivities_ise.f90"])
