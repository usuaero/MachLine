...
# this script tests panel geometry sensitivities (dirichlet subsonic wake appended)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_appended_tests/wake_appended_test1_panel_geom/wake_appended_test1_panel_geom.f90"])
