program wake_appended_test28
    ...
    write(*,*) ""
    write(*,*) "--------------------------------------------------------------------------------------"
    write(*,*) "            dirichlet d_CF_sensitivities_Central_Difference (WAKE APPENDED)"
    write(*,*) "--------------------------------------------------------------------------------------"
    write(*,*) ""
    do i=1,3
    ...
    !!!!!!!!!!!!!!  RESULTS!!!!!!!!!!!!!
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) "            dirichlet d_CF Central Difference TEST RESULTS (WAKE APPENDED) "
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) ""
    write(*,*) ""
...
end program wake_appended_test28
