program wake_test10
    ...
    allocate(v_d_M1_up(3,N_original_verts*3))
    allocate(v_d_M1_dn(3,N_original_verts*3))
    allocate(d_v_d_M1_FD(3,N_original_verts*3))
    allocate(v_d_M2_up(3,N_original_verts*3))
    allocate(v_d_M2_dn(3,N_original_verts*3))
    allocate(d_v_d_M2_FD(3,N_original_verts*3))
    allocate(v_d_M3_up(3,N_original_verts*3))
    allocate(v_d_M3_dn(3,N_original_verts*3))
    allocate(d_v_d_M3_FD(3,N_original_verts*3))
    ...
    write(*,*) ""
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) "                       d_v_d_M TEST (WAKE PRESENT)                    "
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) ""
    write(*,*) ""
    ...
    do y =1,N_panels
        ...
        do z = 1,N_total_verts
            ...
            write(*,'(A,I5,A,I5)') "d_v_d_M test Panel ",y," cp ",z
            ...
            do i=1,3
                do j=1,N_original_verts
                    ...
                    ! get the needed info
                    v_d_M1_up(:, j + (i-1)*N_original_verts) = v_d(1,:)
                    v_d_M2_up(:, j + (i-1)*N_original_verts) = v_d(2,:)
                    v_d_M3_up(:, j + (i-1)*N_original_verts) = v_d(3,:)
                    ...
                    ! get the needed info
                    v_d_M1_dn(:, j + (i-1)*N_original_verts) = v_d(1,:)
                    v_d_M2_dn(:, j + (i-1)*N_original_verts) = v_d(2,:)
                    v_d_M3_dn(:, j + (i-1)*N_original_verts) = v_d(3,:)
    ...
    !!!!!!!!!!!!!!  RESULTS!!!!!!!!!!!!!
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) "                     d_v_d_M TEST RESULTS (WAKE PRESENT)"
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) ""
