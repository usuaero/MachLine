...
# this script tests sensitivities of CP inc of each panel wrt mu (subsonic dirichlet wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_tests/wake_test19_d_CP_inc_mu/wake_test19_d_CP_inc_mu.f90"])
