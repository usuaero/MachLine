...
# this script tests sensitivities of V_inner wrt to mu (dirichlet supersonic wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_super_tests/wake_super_test15_V_inner_mu/wake_super_test15_V_inner_mu.f90"])
