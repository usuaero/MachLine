...
# this script tests V_inner wrt to vars (supersonic dirichlet wakes present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_super_tests/wake_super_test14_V_inner_vars/wake_super_test14_V_inner_vars.f90"])
