...
# this script tests total derivative of CF (dirichlet supersonic wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "src/sparse.f90", "src/flow.f90", "src/base_geom.f90", "src/panel.f90", 
            ...
            "dev/unit_tests/wake_super_tests/wake_super_test26_CF_sensitivities/wake_super_test26_CF_sensitivities.f90"])
