...
# this script tests flow dependent geometry (dirichlet supersonic wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_super_tests/wake_super_test2_panel_flow/wake_super_test2_panel_flow.f90"])
