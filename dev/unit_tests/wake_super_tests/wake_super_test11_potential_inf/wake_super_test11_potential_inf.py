...
# this script tests sensitivities of potential influences (dirichlet supersonic wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_super_tests/wake_super_test11_potential_inf/wake_super_test11_potential_inf.f90"])
