program wake_super_test4
    ...
    integer :: i,j,k,m,n,z, N_original_verts, N_total_verts, N_panels, vert, index, cp_ind
    ...
    write(*,*) ""
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) "   SUPERSONIC CLONED VERTEX LOCATION SENSITIVITIES TEST (WAKE PRESENT)                   "
    write(*,*) "------------------------------------------------------------------------"
    write(*,*) ""
    write(*,*) ""
    ...
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) "  SUPERSONIC CLONED VERTEX LOCATION SENSITIVITIES TEST RESULTS (WAKE PRESENT)"
    write(*,*) "------------------------------------------------------------------------------"
    write(*,*) ""
