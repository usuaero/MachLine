...
# this script tests sensitivities of H integrals (dirichlet supersonic wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_super_tests/wake_super_test9_H_integrals/wake_super_test9_H_integrals.f90"])
