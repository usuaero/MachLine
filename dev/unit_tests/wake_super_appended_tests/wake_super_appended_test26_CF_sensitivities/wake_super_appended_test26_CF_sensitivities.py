...
# this script tests total derivative of CF (dirichlet supersonic wake appended)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_super_appended_tests/wake_super_appended_test26_CF_sensitivities/wake_super_appended_test26_CF_sensitivities.f90"])
