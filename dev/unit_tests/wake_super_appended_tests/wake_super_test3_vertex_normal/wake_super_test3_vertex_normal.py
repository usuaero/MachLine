...
# this script tests vertex normals sensitivities (dirichlet supersonic wake present)
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_super_tests/wake_super_test3_vertex_normal/wake_super_test3_vertex_normal.f90"])
