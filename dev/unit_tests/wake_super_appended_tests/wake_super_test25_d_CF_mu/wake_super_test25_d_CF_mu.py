...
# this script tests CF sensitivities wrt mu (dirichlet supersonic wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_super_tests/wake_super_test25_d_CF_mu/wake_super_test25_d_CF_mu.f90"])
