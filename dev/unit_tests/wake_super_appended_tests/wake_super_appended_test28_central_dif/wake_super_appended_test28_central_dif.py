...
# this script tests just central difference approximations of CF (dirichlet supersonic wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_super_appended_tests/wake_super_appended_test28_central_dif/wake_super_appended_test28_central_dif.f90"])
