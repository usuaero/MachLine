...
# this script tests sensitivies of CF wrt vars (dirichlet supersonic wake present)
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_super_tests/wake_super_test24_d_CF_vars/wake_super_test24_d_CF_vars.f90"])
