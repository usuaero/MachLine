...
# this script tests panel geometry sensitivities for dirichlet supersonic wake present
...
if __name__=="__main__":
    ...
    sp.run(["gfortran", "-fdefault-real-8", "-fbounds-check", "common/json.f90", 
            ...
            "dev/unit_tests/wake_super_tests/wake_super_test1_panel_geom/wake_super_test1_panel_geom.f90"])
