...
def data_plot(comp_method, Mach_numbers):
    ...
    for k,Mach in enumerate(Mach_numbers):
        data_location = 'dev/results/sears_haack/sears_haack_{0}_data_mach_{1}.csv'.format(grid,Mach)
    ...
    # Save figure
    plot_loc = 'dev/results/sears_haack/plots/sears_haack_M_{0}.pdf'.format(Mach)
    plt.savefig(plot_loc)
...
if __name__=="__main__":
    ...
    body_file = "dev/results/sears_haack/sears_haack_{0}.vtk".format(grid)
    input_dict = {
        "flow": {
        ...
        "geometry": {
            ...
            "file": "dev/results/sears_haack/sears_haack_mesh_love.tri",
            "spanwise_axis" : "+y",
            "wake_model": {
                "wake_present" : False,
            },
        ...
        "output" : {
            "body_file" : body_file,
            "control_point_file" : "dev/results/sears_haack/sears_haack_{0}_data_mach_{1}_control_points.vtk".format(grid,M)
        }
    }
    ...
    if control_point_file not in listdir("dev/results/sears_haack/"):
        print(f"The desired file cannot be located:  dev/results/sears_haack/{control_point_file}")
        exit()
    ...
    view.Update()
    save_loc = 'dev/results/sears_haack/sears_haack_{0}_data_mach_{1}.csv'.format(grid,M)
