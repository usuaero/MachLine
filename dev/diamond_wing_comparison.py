...
def run_comparison(M, alpha, grid, half_angle, run_machline=True):
    ...
    body_file = "dev/results/diamond_wing_comparison/meshes/"+case_name+".vtk"
    report_file = "dev/results/diamond_wing_comparison/reports/"+case_name+".json"
    data_file = 'dev/results/diamond_wing_comparison/data/'+case_name+'.csv'
    ...
    if run_machline:
        ...
        input_dict = {
            ...
            "geometry": {
                "file": "dev/meshes/diamond_{0}_deg_full_{1}.stl".format(int(half_angle), grid),
                "spanwise_axis" : "+y",
                "wake_model": {
                    "append_wake" : False,
                },
        ...
        # Dump
        input_file = "dev/results/diamond_wing_comparison/diamond_input.json"
